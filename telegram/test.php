...
def send_chat(text):
        ...
        saartje.bot.send_message(chat_id="1261249355 ", text="dit is een test bericht van saartje")
...
def start(update, context):
    context.bot.send_message(chat_id="1261249355  ", text="I'm a bot, please talk to me!")
...
send_chat("dit is een test bericht van saartje")
